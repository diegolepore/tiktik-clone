...
const Sidebar = () => {
  ...
  return (
    <div>
      ...
      {showSidebar && (
        <div className='flex flex-col justify-start mb-10 w-20 xl:w-400 border-r-2 border-gray-100 xl:border-0 p-3'>
                ...
                <GoogleLogin
                  ...
                  render={ (renderProps) => (
                    <button 
                      ...
                      px-6 py-3 rounded-md outline-none w-full mt-3 cursor-pointer
